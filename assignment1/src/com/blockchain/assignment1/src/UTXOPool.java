...
public class UTXOPool {
    ...
    /** Creates a new empty com.blockchain.assignment1.src.UTXOPool */
    public UTXOPool() {
        H = new HashMap<UTXO, Transaction.Output>();
    }

    /** Creates a new com.blockchain.assignment1.src.UTXOPool that is a copy of {@code uPool} */
    public UTXOPool(UTXOPool uPool) {
        H = new HashMap<UTXO, Transaction.Output>(uPool.H);
    }

    /** Adds a mapping from com.blockchain.assignment1.src.UTXO {@code utxo} to transaction output @code{txOut} to the pool */
    public void addUTXO(UTXO utxo, Transaction.Output txOut) {
        H.put(utxo, txOut);
    }

    /** Removes the com.blockchain.assignment1.src.UTXO {@code utxo} from the pool */
    public void removeUTXO(UTXO utxo) {
        H.remove(utxo);
    }

    /**
     * @return the transaction output corresponding to com.blockchain.assignment1.src.UTXO {@code utxo}, or null if {@code utxo} is
     *         not in the pool.
     */
    ...
    /** @return true if com.blockchain.assignment1.src.UTXO {@code utxo} is in the pool and false otherwise */
